...
const pathname = usePathname()
    return(<div className={`xs:px-2 xs:py-2 md:px-6 md:py-4 lg:px-12 w-full py-6 xs:h-[8%] lg:h-[12%] flex justify-between ${pathname!=='/work' && 'bg-[#cbc4f7]'} items-center top-0`}>
