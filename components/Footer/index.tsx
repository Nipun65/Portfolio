  ...
  return (
    <div className="bg-[#15151e]">
      <div className="xs:px-4 xs:py-4 md:px-6 md:py-4 lg:px-12 lg:py-6 flex flex-col xs:items-start">
        ...
        <p className="text-white mt-3 xs:text-xs lg:text-base">
          Designed & Developed by Nipun. Built with Next.js, React.js,
          Typescript, and Tailwind CSS.
        </p>
        <ul className="flex items-center gap-3 mt-3 pl-[2px] h-fit">
          <Link
            href={"mailto:nipunpatel7@gmail.com"}
            className="lg:h-6 lg:w-6 xs:h-[18px] xs:w-[18px]"
            target="__blank"
          >
            <svg
          ...
          <Link
            href={"https://github.com/Nipun65"}
            className="lg:h-6 lg:w-6 xs:h-5 xs:w-5 ml-1"
            target="__blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
