...
const EXPERIENCES = [{
    ...
    role:'Web Developer',
    logo:"",
    description:["I had the privilege of designing and developing a website for Educare India, an impactful platform that effectively connects passionate volunteers with NGOs, fostering meaningful collaborations and making a positive difference in the community."],
...
const PORTFOLIO = [
  ...
  const SKILLS = [
    ...
    { skill: "HTML", link: "https://developer.mozilla.org/en-US/docs/Glossary/HTML5", logo: htmlImg },
    { skill: "CSS", link: "https://www.w3schools.com/css/", logo: cssImg },
    { skill: "Pug", link: "https://pugjs.org/api/getting-started.html", logo: pugImg },
    { skill: "Node.js", link: "https://nodejs.org/en/docs", logo: nodejs },
    { skill: "MongoDB", link: "https://www.mongodb.com/", logo: mongodb },
    { skill: "Firebase", link: "https://firebase.google.com/", logo: firebaseImg },
    { skill: "Github", link: "https://docs.github.com/en", logo: github },
    { skill: "Gitlab", link: "https://about.gitlab.com/", logo: gitlab },
    { skill: "Jira", link: "https://www.atlassian.com/software/jira", logo: jiraImg },
    { skill: "Python", link: "https://www.youtube.com/watch?v=_uQrJ0TkZlc", logo: pythonImg },
    { skill: "C++", link: "https://www.geeksforgeeks.org/c-plus-plus/", logo: cplusImg },
    { skill: "C", link: "https://www.geeksforgeeks.org/c-programming-language/", logo: cImg },
  ];
